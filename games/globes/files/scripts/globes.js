...
(function(q) {
    var config = {
        pc: {
            freq: 900, freqAccel: 0.9, age: 6000, bonus: 0.85, types: 5, life: 5, hsmax: 5, msize: 0, present: 500
        },
        mobile: {
            freq: 810, freqAccel: 0.9, age: 4000, bonus: 0.9, types: 5, life: 5, hsmax: 5, msize: 5, present: 0
        },
        soundsLocation: 'files/sounds/',
        sounds: {
            'soundLifeUp': 'lifeup.ogg', 'soundGameOver': 'gameover.ogg', 'soundLifeDown': 'lifedown.ogg', 'soundSpeedUp': 'speedup.ogg', 'soundSpeedDown': 'speeddown.ogg', 'soundHit': 'targethit.ogg'
        },
        color: '#0f0',
        text: {
            id: 'sgc',
        ...
        stats: {
            active: {
                desc: '', title: 'Globes on the field', limited: false},
            hit: {
                desc: '', title: 'Globes hit', limited: false},
            points: {
                desc: '', title: 'Points', limited: false},
            life: {
                desc: '', title: 'Lives', limited: false},
            speed: {
                desc: '', title: 'Globes frequency', limited: false}
        },
        options: {
            sound: {
                type: 'button', desc: '', title: 'Toggle sound', visible: true},
            pause: {
                type: 'button', desc: '', title: 'Pause', visible: true},
            exit: {
                type: 'button', desc: '', title: 'Exit the game', visible: true}
        },
        points: {
            1: 0, 2: 0, 3: 1, 4: 2, 5: 3, 6: 0, 7: 0, 8: 1, 9: 2, 10: 3
        },
        size: {
            container: {
                width: 640, height: 480},
            game: {
                width: 574, height: 476, top: 3, left: 63},
            options: {
                width: 60, height: 162, top: 0, left: 0},
            stats: {
                width: 60, height: 318, top: 160, left: 0}
        }
    };
    var txt = config.text;
    var gamec = config.pc;
    ...
    function qbTarget(qbContainer, type) {
        ...
        qb.slide = function() {
            ...
            qb.div.animate({top: qb.container.height}, qb.container.height - qb.top, 'linear', qb.dispose);
        };
    ...
    q.initGlobesInline = function() {
        ...
        GC._bh = 3;
        GC._bw = 3;
        GC.div.css({position: 'relative', top: 0, left: 0});
